...
REM e.g., UE4_MAP=1 equals to UE4_MAP=Grasslands  OldFactory RealForestBLake
...
REM tasklist|find /i "CopterSim.exe" && taskkill /im "CopterSim.exe" 
REM tasklist|find /i "QGroundControl.exe" && taskkill /f /im "QGroundControl.exe" 
REM tasklist|find /i "RflySim3D.exe" && taskkill /f /im "RflySim3D.exe" 
