...
struct B_QuadModelv_T {
  ...
  real_T y_d[8];                       // '<S293>/MotorFaultModel'
  real_T y_kw;                         // '<Root>/MATLAB Function'
  ...
  real_T FaultParam_lx[20];            // '<S67>/FaultParamsExtract3'
...
struct DW_QuadModelv_T {
  ...
  real_T V2_a;                         // '<S398>/Mag NoiseFun'
  real_T S_j;                          // '<S398>/Mag NoiseFun'
  real_T V2_d;                         // '<S398>/Gyro NoiseFun'
  real_T S_n;                          // '<S398>/Gyro NoiseFun'
  real_T fParam_a[20];                 // '<S398>/FaultParamsExtract3'
  real_T fParam_d[20];                 // '<S398>/FaultParamsExtract2'
  real_T fParam_ag[20];                // '<S398>/FaultParamsExtract1'
  real_T fParam_ah[20];                // '<S398>/FaultParamsExtract'
  real_T V2_al;                        // '<S398>/Acc NoiseFun'
  real_T S_jc;                         // '<S398>/Acc NoiseFun'
  real_T fParam_dy[20];                // '<S366>/FaultParamsExtract'
  real_T V2_o;                         // '<S366>/Acc NoiseFun'
  real_T S_c;                          // '<S366>/Acc NoiseFun'
  real_T V2_h;                         // '<S293>/MotorFaultModel'
  real_T S_h;                          // '<S293>/MotorFaultModel'
  real_T fParam_g[20];                 // '<S293>/FaultParamsExtract'
  ...
  uint32_T state_k[2];                 // '<S398>/baro NoiseFun'
  uint32_T state_c[625];               // '<S398>/baro NoiseFun'
  uint32_T method_m;                   // '<S398>/Mag NoiseFun'
  uint32_T state_d;                    // '<S398>/Mag NoiseFun'
  uint32_T state_m[2];                 // '<S398>/Mag NoiseFun'
  uint32_T state_h[625];               // '<S398>/Mag NoiseFun'
  uint32_T method_n;                   // '<S398>/Gyro NoiseFun'
  uint32_T state_g;                    // '<S398>/Gyro NoiseFun'
  uint32_T state_d5[2];                // '<S398>/Gyro NoiseFun'
  uint32_T state_hm[625];              // '<S398>/Gyro NoiseFun'
  uint32_T method_l;                   // '<S398>/Acc NoiseFun'
  uint32_T state_e;                    // '<S398>/Acc NoiseFun'
  uint32_T state_n[2];                 // '<S398>/Acc NoiseFun'
  uint32_T state_a[625];               // '<S398>/Acc NoiseFun'
  uint32_T method_p;                   // '<S366>/Acc NoiseFun'
  uint32_T state_nf;                   // '<S366>/Acc NoiseFun'
  uint32_T state_l[2];                 // '<S366>/Acc NoiseFun'
  uint32_T state_ds[625];              // '<S366>/Acc NoiseFun'
  uint32_T method_a;                   // '<S293>/MotorFaultModel'
  uint32_T state_j;                    // '<S293>/MotorFaultModel'
  uint32_T state_nl[2];                // '<S293>/MotorFaultModel'
  uint32_T state_a0[625];              // '<S293>/MotorFaultModel'
  uint32_T method_d;                   // '<S67>/MATLAB Function'
  uint32_T state_aj;                   // '<S67>/MATLAB Function'
  uint32_T state_i[2];                 // '<S67>/MATLAB Function'
  uint32_T state_al[625];              // '<S67>/MATLAB Function'
  uint32_T method_ay;                  // '<Root>/Crash_Motor_Fault'
  uint32_T state_cy;                   // '<Root>/Crash_Motor_Fault'
  uint32_T state_f[2];                 // '<Root>/Crash_Motor_Fault'
  uint32_T state_gl[625];              // '<Root>/Crash_Motor_Fault'
  uint32_T method_l0;                  // '<Root>/CollisionDetection'
  uint32_T state_mn;                   // '<Root>/CollisionDetection'
  ...
  boolean_T phase_j;                   // '<S398>/Mag NoiseFun'
  boolean_T phase_h;                   // '<S398>/Gyro NoiseFun'
  boolean_T hFault_g;                  // '<S398>/FaultParamsExtract3'
  boolean_T hFault_k;                  // '<S398>/FaultParamsExtract2'
  boolean_T hFault_kf;                 // '<S398>/FaultParamsExtract1'
  boolean_T hFault_n;                  // '<S398>/FaultParamsExtract'
  boolean_T phase_m;                   // '<S398>/Acc NoiseFun'
  boolean_T hFault_d;                  // '<S366>/FaultParamsExtract'
  boolean_T phase_d;                   // '<S366>/Acc NoiseFun'
  boolean_T phase_mg;                  // '<S293>/MotorFaultModel'
  boolean_T hFault_m;                  // '<S293>/FaultParamsExtract'
  ...
  class MulticopterModelClass
{
 ...
 private:
  ...
  real_T QuadModelv_rand_a(void);
  real_T QuadModelv_rand_l(void);
  real_T QuadModelv_rand_b(void);
  real_T QuadModelv_rand_jq(void);
  real_T QuadModelv_rand_j(void);
