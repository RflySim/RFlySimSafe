        ...
        while True:
            ...
            if self.UDPMode>1.5: # If Use MAVLink Mode
                msg = self.the_connection.recv_match(
                    type=['ATTITUDE','ATTITUDE_QUATERNION', 'LOCAL_POSITION_NED','HEARTBEAT','HOME_POSITION','GLOBAL_POSITION_INT','HIL_ACTUATOR_CONTROLS','STATUSTEXT','ATTITUDE_TARGET','BATTERY_STATUS','HIGHRES_IMU','VIBRATION','GPS_RAW_INT','SERVO_OUTPUT_RAW'],
                    blocking=True)
                if msg is not None:
