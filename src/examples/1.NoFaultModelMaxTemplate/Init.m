...
%Sensor Fault Struct
SensorFault.GPSFaultID = 123546;


FaultParamAPI.FaultInParams(1)= 190;% Accelerometer natural frequency (rad/sec)
FaultParamAPI.FaultInParams(2)=0.707; %Accelerometer damping ratio
FaultParamAPI.FaultInParams(3)=0; % Accelerometer measurement bias-x
FaultParamAPI.FaultInParams(4)=0; % Accelerometer measurement bias-y
FaultParamAPI.FaultInParams(5)=0; % Accelerometer measurement bias-z

FaultParamAPI.FaultInParams(6)= 190;% Accelerometer natural frequency (rad/sec)
FaultParamAPI.FaultInParams(7)=0.707; % Gyro damping ratio
FaultParamAPI.FaultInParams(8)=0; % Gyro measurement bias-x
FaultParamAPI.FaultInParams(9)=0; % Gyro measurement bias-y
FaultParamAPI.FaultInParams(10)=0; % Gyro measurement bias-z
FaultParamAPI.FaultInParams(11)=0; % G-sensitive bias
FaultParamAPI.FaultInParams(12)=0; % G-sensitive bias
FaultParamAPI.FaultInParams(13)=0; % G-sensitive bias
